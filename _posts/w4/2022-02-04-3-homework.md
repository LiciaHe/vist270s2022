...
## Part 1: Maya Sphere Design (partially covered in lab):  <span style="color:#0000ff;"> 2.5%  </span>
...
The result of the sphere will look similar to this ![](../../../assets/w3/Pasted image 20220204203238.png) 
...
```
Calling the function will generate a sphere similar to this:
![](../../../assets/w3/Pasted image 20220204205604.png)
When you are done, fill in the answer sheet. 
...
![](../../../assets/w3/Pasted image 20220204205930.png)

You can adjust the radius to get different configurations 
![](../../../assets/w3/Pasted image 20220204205956.png)
...
2. The tiles are scalable. It should work for any tile size: e.g., 40x40px, 10 x 10 px, 100 x 100 px. 
	1. e.g., your designs should work in both of the following compositions:
		1. ![](../../../assets/w3/layout0.png) 30 px, 10 by 10 grid 
		2. ![](../../../assets/w3/layout0_lg.png) 50px, 25 by 5 grid 
		3. ![](../../../assets/w3/layout3.png) randomized location and size 
...
Create a script `hw3_part2.py` and  `hw3_part2_test.py`. 
...
* `hw3_part2_test.py` is a file for you to test your designs. In this file, you will 
	...
	* Put your tile designs into test layouts.
	* e.g., running the following code should test your design in a standard grid layout:

```
import turtle as T_mod  
import hw3_part2 as HW3 #import your file   
...
def test_layout():  
	...
	for i in range(col_ct):  
		...
		y=cell_size*j-row_ct*cell_size/2  
		HW3.tile0( 
			turtle=turtle,  
			screen=screen,  
			x=x,  
	...
	screen.update()  
	# T_mod.done() #uncomment to keep the screen open
