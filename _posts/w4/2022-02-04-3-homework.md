...
Write your part 1 in a file `hw4_part1.py`
...
Create a script `hw4_part2.py` and  `hw4_part2_test.py`. 

* `hw4_part2.py` stores all the information you need to generate the tile designs. It will have at least five functions (one for each tile design). Calling these functions with a specific cell setting will trigger a drawing at a particular location. 
...
* `hw4_part2_test.py` is a file for you to test your designs. In this file, you will 
	* import your `hw4_part2` as a module 
	* Put your tile designs into test layouts.
	* e.g., running the following code should test your design in a standard grid layout:

```
import turtle as T_mod  
import hw4_part2 as Hw4 #import your file   
...
- Develop the script in a new file `hw4_part2_layout.py`
