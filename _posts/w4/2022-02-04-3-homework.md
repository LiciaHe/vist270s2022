...
Create a script `hw3_part2.py` and  `hw3_part2_test.py`. Download the `layout.py` from [this link](../../../assets/w4/layout.py). **Make sure your `layout.py` is in the same folder with `hw3_part2.py`  and `hw3_part2_test.py`**  
...
`hw3_part2_test.py` is a file for you to test your designs. In this file, you will 
	* import `layout.py`, which we have written for you. 
		* You can download the `layout.py` from [this link](../../../assets/w4/layout.py). **Make sure your `layout.py` is in the same folder with `hw3_part2.py`  and `hw3_part2_test.py`**  
...
- [layout](../../../assets/w4/layout.py)
- [hw3_part2.py](../../../assets/w4/hw3_part2.py)
- [hw3_part2_test.py](../../../assets/w4/hw3_part2_test.py)
