...
## Part 1: PIL Image and ImageDraw[(lab video updated on Monday night)]():  <span style="color:#0000ff;"> 3%  </span>
...
- If RGB color is difficult to think about manually, try using HSV instead. 
