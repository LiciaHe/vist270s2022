...
You are provided with some test paths in the file `test_paths.py` #todo
...
## Part 1: Maya Brush Design [( video available on Monday evening)]():  <span style="color:#0000ff;"> 3%  </span>
